...
<div class = "totalcontainer_1">
	<div class = "container">
		<div class = "row  ">
			...
			<div class = "col-sm-9">
				<div class = "info_mj">
					<h3 class = "causeMachen_mj">김 예 림</h3>
				</div>
			
				<div class = "videoSize_mj">
					<iframe width="600" height="350" src="https://www.youtube.com/embed/9pqc-ETB7kg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
				...
				<div class = "des_1">
					<div class = "descriptionMappen_mj">
						...
						<div class = "col-sm-6  desc2_mj ">
							<div class = "col-sm-6   ">
								<img src = "<%=request.getContextPath()%>/images/QRcode_yr.png" alt = "web Mappen QR"  class = "QRsize_mj"/>
								<p>JSP 웹 포트폴리오 QR 코드입니다.</p>
							</div>
							<div class = "col-sm-6  ">
								<img src = "<%=request.getContextPath()%>/images/QRCodeJava_yr.jpg" alt = "web Mappen QR" class = "QRsize_mj"/>
								<p>JAVA 포트폴리오 QR 코드입니다.</p>
							</div>
						</div>
						
					</div><!-- end  descriptionMappen_mj-->
				</div>
