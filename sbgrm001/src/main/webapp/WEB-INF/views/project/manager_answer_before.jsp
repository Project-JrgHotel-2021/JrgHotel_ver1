			...
			<tbody>
			 <c:forEach var="dto" items="${list}" varStatus="stauts">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/do/manager_answer_detail?bno=${dto.boardDto.bno}" title="답변여부 확인" class="btn btn-colored">답변대기중</a></td>
				</tr>
			</c:forEach> 
			</tbody>		
		</table>
