			...
			<div class="reservation_detail_table">
					...
					<thead>
						<tr>
							<th scope="row" colspan="2">
								<div class="reservation_check_img">
									<img src="${pageContext.request.contextPath}/images/${dto.roomimageDto.riimage}" alt="룸사진"/>
								</div>
							</th>
						</tr>
						
						<!--../resources/images/roomimg.PNG  -->
					</thead>
					<tbody>
				...
				<div class="reservation_check_foot">
					...
					<div class="reservation_backBtn">
						<a href="#" onclick="history.go(-1)"; title="뒤로가기" class="btn btn-colored">뒤로가기</a>
					</div>
				</div>
			</div>
		</div>
